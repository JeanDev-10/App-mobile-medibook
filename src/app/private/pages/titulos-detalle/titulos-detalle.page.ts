...
medico_id!:any;
titulo!:any;
  constructor(private formBuid:FormBuilder,private tituloService:TituloService,private notificacion:ToastService,private router:Router,private activatedRoute:ActivatedRoute) {
